...
namespace FoodTruckNationApi.FoodTrucks
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateFoodTruckModelV11"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the name to give to the new Food Truck.
        /// </summary>
        public string Name { get; set; }

        /// <summary>
        /// Gets or sets the description of the new food truck.
        /// </summary>
        public string Description { get; set; }

        /// <summary>
        /// Gets or sets the website of the new food truck.
        /// </summary>
        public string Website { get; set; }

        /// <summary>
        /// Gets or sets a list of tags to be attached to the new food truck.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Gets or sets a list of social media accounts to be attached to the new food truck.
        /// </summary>
        /// <remarks>
        ...
        {
            /// <summary>
            /// Gets or sets the id number of the social media platform this account is for.
            /// </summary>
            /// <remarks>
            ...
            /// <summary>
            /// Gets or sets the account name on this social media platform for the food truck.
            /// </summary>
